...
branch1 = conv_1d(net, 300, 3, padding='valid', activation='relu', regularizer="L2")
branch2 = conv_1d(net, 300, 5, padding='valid', activation='relu', regularizer="L2")
branch3 = conv_1d(net, 300, 7, padding='valid', activation='relu', regularizer="L2")
