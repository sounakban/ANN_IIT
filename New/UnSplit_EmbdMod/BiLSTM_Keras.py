...
forwards = LSTM(60, return_sequences=True, activation='relu')(embed_layer)
backwards = LSTM(60, return_sequences=True, go_backwards=True, activation='relu')(embed_layer)
