...
forwards = LSTM(512, return_sequences=True, activation='tanh', recurrent_activation='relu')(embed_layer)
backwards = LSTM(512, return_sequences=True, go_backwards=True, activation='tanh', recurrent_activation='relu')(embed_layer)
