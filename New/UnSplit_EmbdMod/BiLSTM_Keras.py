...
forwards = LSTM(1024, return_sequences=True, activation='tanh')(embed_layer)
backwards = LSTM(1024, return_sequences=True, go_backwards=True, activation='tanh')(embed_layer)
...
# mlp = TimeDistributed(Dense(256, activation='relu'))(seq)
