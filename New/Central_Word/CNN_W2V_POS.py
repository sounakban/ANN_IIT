...
branch1 = conv_1d(net, 300, 2, padding='valid', activation='relu', regularizer="L2")
branch2 = conv_1d(net, 300, 3, padding='valid', activation='relu', regularizer="L2")
branch3 = conv_1d(net, 300, 4, padding='valid', activation='relu', regularizer="L2")
